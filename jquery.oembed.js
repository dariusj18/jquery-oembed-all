...
(function($) {
	...
	*/  
	function json_encode(jsObject)   
	{             
		try { return JSON.stringify(jsObject); }   
		catch(e) { return null; }  
	}  
	  
	/* 
	*  To convert a JSON string into a JavaScript object, pass the string into the JSON.parse() 
	*  eval() || JSON.parse() 
	*/  
	function json_decode(jsString)   
	{             
		try { return eval("(" + jsString + ")"); }   
		catch(e) { return null; }  
	}
	...
	new $.fn.oembed.OEmbedProvider("imgur.com", "photo", ["imgur\\.com/.+"], "http://api.imgur.com/oembed", {useYQL:"json"}),
